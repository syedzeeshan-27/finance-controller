...
- **[S1] Settlement never hit the bank** — `setl_FnMESBpgGpLt1R` · ₹1,00,159.97 · 70d overdue
  Raise with the PSP/bank: settlement processed but no credit arrived. Share the UTR and expected amount.
- **[S1] Duplicate bank posting** — `BANK000214` · ₹96,241.48
  Ask the bank to reverse the duplicate posting; park the amount in a suspense account meanwhile.
- **[S1] Duplicate bank posting** — `BANK000036` · ₹73,427.65
  Ask the bank to reverse the duplicate posting; park the amount in a suspense account meanwhile.
- **[S1] Duplicate bank posting** — `BANK000024` · ₹63,895.71
  Ask the bank to reverse the duplicate posting; park the amount in a suspense account meanwhile.
- **[S1] Duplicate bank posting** — `BANK000516` · ₹63,421.44
  Ask the bank to reverse the duplicate posting; park the amount in a suspense account meanwhile.
- **[S1] Duplicate bank posting** — `BANK000072` · ₹57,333.01
  Ask the bank to reverse the duplicate posting; park the amount in a suspense account meanwhile.
- **[S1] Settlement never hit the bank** — `setl_LKMe9fPZ13wFzB` · ₹42,265.73 · 173d overdue
  Raise with the PSP/bank: settlement processed but no credit arrived. Share the UTR and expected amount.
- **[S1] Settlement never hit the bank** — `setl_ib3PynA2qoh8wI` · ₹41,541.91 · 20d overdue
  Raise with the PSP/bank: settlement processed but no credit arrived. Share the UTR and expected amount.
...
- **[S1] Settlement never hit the bank** — `setl_f4xtvdmwcmFq3k` · ₹38,232.93 · 21d overdue
  Raise with the PSP/bank: settlement processed but no credit arrived. Share the UTR and expected amount.
- **[S1] Duplicate bank posting** — `BANK000255` · ₹37,506.02
  Ask the bank to reverse the duplicate posting; park the amount in a suspense account meanwhile.
- **[S1] Settlement never hit the bank** — `setl_RIQajD6bZ9zNsc` · ₹33,880.24 · 126d overdue
  Raise with the PSP/bank: settlement processed but no credit arrived. Share the UTR and expected amount.
- **[S1] Settlement never hit the bank** — `setl_KUhy3lUTT0GYbn` · ₹33,746.90 · 84d overdue
  Raise with the PSP/bank: settlement processed but no credit arrived. Share the UTR and expected amount.
- **[S1] Duplicate bank posting** — `BANK000048` · ₹32,297.89
  Ask the bank to reverse the duplicate posting; park the amount in a suspense account meanwhile.
- **[S1] Duplicate bank posting** — `BANK000026` · ₹23,291.25
  Ask the bank to reverse the duplicate posting; park the amount in a suspense account meanwhile.
- **[S1] Settlement never hit the bank** — `setl_p8fRJWgCkyhhRn` · ₹21,242.53 · 154d overdue
  Raise with the PSP/bank: settlement processed but no credit arrived. Share the UTR and expected amount.
- **[S1] Settlement never hit the bank** — `setl_363dKu4Zj7CivY` · ₹19,523.35 · 136d overdue
  Raise with the PSP/bank: settlement processed but no credit arrived. Share the UTR and expected amount.
- **[S1] Settlement never hit the bank** — `setl_DVtTlwRhvdrb4l` · ₹14,837.17 · 7d overdue
  Raise with the PSP/bank: settlement processed but no credit arrived. Share the UTR and expected amount.
- **[S1] Settlement never hit the bank** — `setl_2P9gtHIOEe4X6R` · ₹13,964.29 · 172d overdue
  Raise with the PSP/bank: settlement processed but no credit arrived. Share the UTR and expected amount.
- **[S1] Settlement never hit the bank** — `setl_nr8PCSUFwvyQj4` · ₹11,633.80 · 123d overdue
  Raise with the PSP/bank: settlement processed but no credit arrived. Share the UTR and expected amount.
- **[S1] Duplicate bank posting** — `BANK000524` · ₹2,535.99
  Ask the bank to reverse the duplicate posting; park the amount in a suspense account meanwhile.
...
- **[S1] Settlement never hit the bank** — `setl_Svf2FHsiDIfnqI` · ₹1,362.29 · 86d overdue
  Raise with the PSP/bank: settlement processed but no credit arrived. Share the UTR and expected amount.
- **[S2] Bank credit with no settlement** — `BANK000462` · ₹1,00,225.75
  Verify source of funds with the bank; confirm whether this is an out-of-band payout.
- **[S2] Ambiguous match — abstained** — `BANK000199` · ₹43,489.50
  Confirm with the bank which settlement this credit belongs to before claiming either.
- **[S2] Ambiguous match — abstained** — `setl_HVhv55afUoKaPg` · ₹43,489.50 · 119d overdue
  Confirm with the bank which settlement this credit belongs to before claiming either.
- **[S2] Ambiguous match — abstained** — `setl_QR5vFV82L23GKi` · ₹43,489.50 · 117d overdue
  Confirm with the bank which settlement this credit belongs to before claiming either.
- **[S2] Bank credit with no settlement** — `BANK000442` · ₹43,362.47
  Verify source of funds with the bank; confirm whether this is an out-of-band payout.
- **[S2] Bank credit with no settlement** — `BANK000447` · ₹40,609.81
  Verify source of funds with the bank; confirm whether this is an out-of-band payout.
- **[S2] Ambiguous match — abstained** — `BANK000147` · ₹32,675.31
  Confirm with the bank which settlement this credit belongs to before claiming either.
- **[S2] Ambiguous match — abstained** — `setl_cyEfiR4Tv3wN7i` · ₹32,675.31 · 133d overdue
  Confirm with the bank which settlement this credit belongs to before claiming either.
- **[S2] Ambiguous match — abstained** — `setl_o4dCZsCXjLGnjy` · ₹32,675.31 · 133d overdue
  Confirm with the bank which settlement this credit belongs to before claiming either.
- **[S2] Duplicate payment on one order** — `pay_mNu7uhbqoty1ra;order_dTcLrHwSIWQK34` · ₹27,525.00
  Two captures against one order — refund the duplicate payment.
- **[S2] Duplicate payment on one order** — `pay_lB50jFRVXFXdAT;order_MX1pK6uYMTZc9B` · ₹24,424.36
  Two captures against one order — refund the duplicate payment.
- **[S2] Duplicate payment on one order** — `pay_FSvgfKZXUMyGyQ;order_dxvwURpTITCCrG` · ₹24,421.00
  Two captures against one order — refund the duplicate payment.
- **[S2] Bank credit with no settlement** — `BANK000134` · ₹23,764.55
  Verify source of funds with the bank; confirm whether this is an out-of-band payout.
- **[S2] Duplicate payment on one order** — `pay_5GllnA9bEUCCck;order_1ToqevuAYoYWYR` · ₹20,972.00
  Two captures against one order — refund the duplicate payment.
- **[S2] Duplicate payment on one order** — `pay_9xEa77pChbtw0P;order_dt8mM2DIbN4Uya` · ₹17,582.00
  Two captures against one order — refund the duplicate payment.
- **[S2] Bank credit with no settlement** — `BANK000344` · ₹14,574.35
  Verify source of funds with the bank; confirm whether this is an out-of-band payout.
- **[S2] Payment and order amounts differ** — `order_bcZMrxudjfI404;pay_CGSwBEAf5Zy3x5` · ₹6,540.16
...
- **[S2] Payment and order amounts differ** — `order_Wfwz49nEqhBH0z;pay_MMKRbIJfF2AnJX` · ₹6,495.30
  Captured amount differs from the order — confirm the intended price with the customer/ops and refund or collect the difference.
- **[S2] Payment and order amounts differ** — `order_KngX2rJ3EuqrJH;pay_x7dLglHKqcA37O` · ₹6,446.84
  Captured amount differs from the order — confirm the intended price with the customer/ops and refund or collect the difference.
- **[S2] Duplicate payment on one order** — `pay_UAgw4SmdIasy9s;order_DGvYY9czelR3v4` · ₹5,913.00
  Two captures against one order — refund the duplicate payment.
- **[S2] Duplicate payment on one order** — `pay_D6usOVqhpLY0Dq;order_ZxNeKD0Ik1gLaP` · ₹5,902.00
  Two captures against one order — refund the duplicate payment.
- **[S2] Duplicate payment on one order** — `pay_qg09n6qv3el1IF;order_0I1DsvFiDe8JRR` · ₹5,815.00
  Two captures against one order — refund the duplicate payment.
- **[S2] Payment and order amounts differ** — `order_OMzysfdttGQyWt;pay_0qviG0aU1y2VY0` · ₹4,423.50
  Captured amount differs from the order — confirm the intended price with the customer/ops and refund or collect the difference.
- **[S2] Duplicate payment on one order** — `pay_OrwSooGM7762Ym;order_mgrITVPW6dPrEq` · ₹4,363.00
  Two captures against one order — refund the duplicate payment.
- **[S2] Payment and order amounts differ** — `order_0RMPYgVQlLKBwM;pay_lPZIYhFk7jUwxy` · ₹4,145.96
  Captured amount differs from the order — confirm the intended price with the customer/ops and refund or collect the difference.
- **[S2] Payment and order amounts differ** — `order_Stl8XKBngSdVfL;pay_HhQAg1YCamNBQD` · ₹4,082.91
  Captured amount differs from the order — confirm the intended price with the customer/ops and refund or collect the difference.
- **[S2] Duplicate payment on one order** — `pay_2BGh5kDyVLaNbm;order_o9wVOcLGwj8vhr` · ₹3,987.00
  Two captures against one order — refund the duplicate payment.
...
- **[S2] Duplicate payment on one order** — `pay_tTSpZkwObF2gmb;order_yvhY6FFXuRxSGV` · ₹1,752.00
  Two captures against one order — refund the duplicate payment.
- **[S2] Duplicate payment on one order** — `pay_01SMe19xgCJfjC;order_86UL3vGEGk08uq` · ₹1,353.00
  Two captures against one order — refund the duplicate payment.
- **[S2] Payment and order amounts differ** — `order_uZx2J17j8StHiL;pay_dbGNTK34MozWTn` · ₹1,092.42
  Captured amount differs from the order — confirm the intended price with the customer/ops and refund or collect the difference.
- **[S2] Payment and order amounts differ** — `order_tZIntoH7yfevix;pay_IULLyf1y5mFHZg` · ₹755.92
  Captured amount differs from the order — confirm the intended price with the customer/ops and refund or collect the difference.
- **[S2] Payment and order amounts differ** — `order_gqImtad8qok5oR;pay_ZFikViJNcPC5PH` · ₹698.60
  Captured amount differs from the order — confirm the intended price with the customer/ops and refund or collect the difference.
- **[S2] Duplicate payment on one order** — `pay_hNvyxU4Xa4iCgW;order_l4zwSXJ8M6bdFq` · ₹673.00
  Two captures against one order — refund the duplicate payment.
...
- **[S2] Payment and order amounts differ** — `order_w6DkVRwNksO3BS;pay_7sov1t0etATSFK` · ₹242.88
  Captured amount differs from the order — confirm the intended price with the customer/ops and refund or collect the difference.
- **[S2] Payment and order amounts differ** — `order_ci1XhsLVvOSbj6;pay_7c9BPsINIzqO8z` · ₹215.20
  Captured amount differs from the order — confirm the intended price with the customer/ops and refund or collect the difference.
...
- **[S2] Duplicate payment on one order** — `pay_2AaJxqXG5uZJTn;order_vofkAhCMuxVVfG` · ₹164.00
  Two captures against one order — refund the duplicate payment.
- **[S2] Payment and order amounts differ** — `order_CXmoNBXvKwMgLp;pay_jB2XAKo5cvoRWh` · ₹150.56
  Captured amount differs from the order — confirm the intended price with the customer/ops and refund or collect the difference.
- **[S2] Payment and order amounts differ** — `order_jOdNgp1ijYGgr2;pay_9uQTSnf7tX10xg` · ₹141.57
  Captured amount differs from the order — confirm the intended price with the customer/ops and refund or collect the difference.
...
- **[S2] Payment and order amounts differ** — `order_VE4cNipsVtal3I;pay_41fXjVmGWPpqdI` · ₹42.24
  Captured amount differs from the order — confirm the intended price with the customer/ops and refund or collect the difference.
- **[S2] Payment and order amounts differ** — `order_qZhZ8avn2Xivyt;pay_bgYnuDzOrcva2l` · ₹37.80
  Captured amount differs from the order — confirm the intended price with the customer/ops and refund or collect the difference.
- **[S2] Payment and order amounts differ** — `order_WfBOxAEbtxLHFY;pay_hTY8v9MdcBVsgE` · ₹28.27
  Captured amount differs from the order — confirm the intended price with the customer/ops and refund or collect the difference.
...
- **Settlements ↔ bank**: 545 decisions, ₹83,79,029.87 matched
  - ambiguous_abstain: 6
  - duplicate_credit: 9
  - exception_missing_bank: 16
  - exception_missing_settlement: 5
  - matched: 176
  - matched_merged: 2
  - matched_split: 11
  - matched_with_discrepancy: 13
  - non_settlement_credit: 18
  - out_of_scope: 289
- **Payments ↔ orders**: 1721/1982 order journeys intact
  - exception_amount_mismatch: 52
  - exception_duplicate_payment: 19
  - exception_payment_no_order: 12
  - exception_unpaid_order: 76
  - order_cancelled: 47
  - order_paid: 1789
  - order_refunded: 44
